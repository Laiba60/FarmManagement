...
>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3 px-3 py-2">
                    <div className="text-[#0d141c]" data-icon="MapTrifold" data-size="24px" data-weight="regular">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                        <path
                    ...
                    <p className="text-[#0d141c] text-sm font-medium leading-normal">Missions</p>
                  </div>
                  <div className="flex items-center gap-3 px-3 py-2">
                  ...
                  <div className="flex items-center gap-3 px-3 py-2">
                    ...
                    <p className="text-[#0d141c] text-sm font-medium leading-normal">Account</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <div className="flex min-w-72 flex-col gap-3">
                ...
                <p className="text-[#49739c] text-sm font-normal leading-normal">Welcome back, Farmer McGregor</p>
              </div>
            </div>
            <h2 className="text-[#0d141c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Robot Features</h2>
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#49739c] text-sm font-normal leading-normal">Precision Spraying</p>
                  <p className="text-[#0d141c] text-base font-bold leading-tight">Advanced Nozzle Control</p>
  ...
  style={{
    backgroundImage:
      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDSof2Gwo5mDZH1I6Kc5beEw-z85k1FCMNGymFr8kcUzQSZyZy0NoTX2HQquKA3Ob8ih_OTiplee43r9SKbtBhjrCrO1dZCUCMBJxxRBxIQuZqLZVvGhaw4o7olU7HCrfDbUK2MIpAgmb2Ml4QYQVHH97vQN8R_f64mr81t_ji6V8Qhzbq1eKbIxIAscqabWMBQc0dRnt1pA9pD-OTbWrrscDdnk1wzDdyWbREm3xJOVPMgsSVOEgrvxS8z3RZUz3FMa-3YLE5bwlPR")'
  }}
></div>
            ...
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#49739c] text-sm font-normal leading-normal">Autonomous Navigation</p>
                  <p className="text-[#0d141c] text-base font-bold leading-tight">GPS-Guided Precision</p>
...
></div>
            ...
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#49739c] text-sm font-normal leading-normal">Real-Time Monitoring</p>
                  <p className="text-[#0d141c] text-base font-bold leading-tight">Live Data Insights</p>
                  <p className="text-[#49739c] text-sm font-normal leading-normal">
  ...
  style={{
    backgroundImage:
      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuD6RitLCWcXX7jYNXcer_bDvodY-x5sQzEFqbMmWn0d4hs_OhmL19_93KdGSiMKYwGMpVHDozi8XKxq0MdliEOwQzMVXb-11sWVFWPRzF79Dco7so3My84G8N6MMHB7LvbZydKNfXhmuZoN3NxMC6uV8jY-a8a3333zvYsIIEtrz09PtluMRA4a1U0_x4UE8nR6aSkdNIMyXycvs6uUO_wgbRtoQzdGDfGQ2Z7HFW-aDlsspXWFe3SkQEflKlguFf5vH9CHTkjImXA-")'
  }}
></div>

              </div>
            </div>
            <h2 className="text-[#0d141c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Rental Prices</h2>
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#0d141c] text-base font-bold leading-tight">Flexible Rental Options</p>
                  <p className="text-[#49739c] text-sm font-normal leading-normal">
  ...
  style={{
    backgroundImage:
      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBQMk0sPLO3IFtWLXgF3Fkh9M3Ewl8dcA_SA-XtQmtioP5fWEfD6fl-MTHwASuhLhlqouuj5WAmLb7o9SwySFiTZdJdqjHaDimaPjvpbzo5dmHFfPPXg5rV6WjliluFbde6c6Exq5O3uiHVBTxgrKMLxWMBdelMyDbLB-sU99NQ0ruOwXdUrwHHprK15ZnGOE6H77crwAXztQDhOIeuyFQei4w1J8sHs0EB5h4I9e3KeEu6-hu6n0EmzC-nzzhlWUeSGjCZq9V3O_83")'
  }}
></div>

              </div>
            </div>
            <h2 className="text-[#0d141c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Precision Spraying Details</h2>
            <div className="flex flex-wrap gap-4 p-4">
              <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-lg p-6 border border-[#cedbe8]">
                <p className="text-[#0d141c] text-base font-medium leading-normal">Remaining Spray</p>
                <p className="text-[#0d141c] tracking-light text-2xl font-bold leading-tight">85%</p>
              </div>
              <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-lg p-6 border border-[#cedbe8]">
                <p className="text-[#0d141c] text-base font-medium leading-normal">Previous Work</p>
                <p className="text-[#0d141c] tracking-light text-2xl font-bold leading-tight">20 acres</p>
              </div>
            </div>
            <h2 className="text-[#0d141c] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Mission Planning</h2>
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-lg">
                <div className="flex flex-col gap-1 flex-[2_2_0px]">
                  <p className="text-[#0d141c] text-base font-bold leading-tight">Plan Your Next Mission</p>
                  <p className="text-[#49739c] text-sm font-normal leading-normal">
  ...
  style={{
    backgroundImage:
      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuClOBnLC3IgzPFeh0_qGG37gnOAMzauYEEEXh9ijdhhvSsByLcmH5g87ISsrH4Y46eryaUFyfJ2fDspV7cUi7itAPpyUOibYPwGFEQKN_yZK_2WBh-3I0bEC-APR0WXhO0iZ4g9K0DLhPs9DH7te8iQr9tuCFXNRxGKHKBPVRkPmts4pV7GXTA3k2OwGBN_KD19CYEIFBA55TLvIJPjx88kYYHM3AoyhD9Oto5ukG4h3pi1wN1W0tz4UAc3ZD6EWprLQiJX_0QzuDQM")'
  }}
></div>
